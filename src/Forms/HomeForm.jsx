...
function HomeForm() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2  ">
      ...
      <div className="  bg-gray-200 rounded-lg shadow-lg max-h-500">
        {/* <div className="max-h-200 max-h-500 bg-cover">
          <img
        ...
        <h2>can add any other thing that you want </h2>
      </div>

      {/* Second div with form */}
      <div className="container max-w-md mx-auto p-6 bg-transparent rounded-lg shadow-lg">
        <h1 className="text-2xl font-bold text-white mb-4 text-center">
          Create Account
        </h1>
        <div className="form__message form__message--error text-center"></div>
        <form className="space-y-4 text-gray-700">
          ...
          <div className="form__input-group">
            <input
              ...
              className="w-full px-3 py-2 rounded-b-lg outline-none focus:border-b-2 focus:border-black hover:border-dark"
              autoFocus
            />
          ...
          <button
            type="submit"
            className="w-full bg-orange-400 text-white rounded px-4 py-2 hover:bg-blue-600 focus:outline-none"
          >
            Create
          </button>
        </form>
